package com.debritto.edusco.Ortu;
...
public class LoginOrtuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            SharedPreferences sharedPreferences = getSharedPreferences("Cari_nis_ortu", Context.MODE_PRIVATE);
    ...
    public void onBackPressed() {
        Intent i = new Intent(LoginOrtuActivity.this, MainActivity.class);
        startActivity(i);
        finish();
    }
    ...
    public void Cari(View view) {
        ...
        Intent i = new Intent(LoginOrtuActivity.this, CariNISOrtuActivity.class);
        startActivity(i);
        finish();
    }
    ...
    public String sendGetRequestLogin() {
        ...
        try {
            URL url = new URL("https://eduscotest.educationscoring.com/Ortu/login_ortu.php?nis=" + nis + "&password=" + pass);
    ...
    private void getJSONLogin() {
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(LoginOrtuActivity.this, "Proses Masuk", "Tunggu sebentar", false, false);
            }
    ...
    private void showLogin() {
        ...
        try {
            ...
            NIS = AES_Enkripsi.decrypt(nis, "loginortunis");
            Nama = AES_Enkripsi.decrypt(nama, "loginortunama");
            Kelas = AES_Enkripsi.decrypt(kelas, "loginortukelas");
            ...
            if (nis.isEmpty() || nama.isEmpty() || kelas.isEmpty() || noPresensi.isEmpty()) {
                ...
                try {
                    ...
                    SharedPreferences sharedPreferences = getSharedPreferences("profile_ortu", Context.MODE_PRIVATE);
                    ...
                    SharedPreferences sharedPreferences1 = getSharedPreferences("Cari_nis_ortu", Context.MODE_PRIVATE);
                    ...
                    editor2.putInt("Login", 3);
                    editor2.apply();

                    // Perintah untuk menuju MainOrtuActivity
                    Intent i = new Intent(LoginOrtuActivity.this, MainOrtuActivity.class);
                    startActivity(i);
                    finish();
