package com.debritto.edusco.Ortu.Fragment;
...
public class ProfileOrtuFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_profile_ortu, container, false);
        return view;
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        try {
            ...
            SharedPreferences sharedPreferences = getActivity().getSharedPreferences("profile_ortu", Context.MODE_PRIVATE);
        ...
        btn_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SharedPreferences sharedPreferences1 = getActivity().getSharedPreferences("Cari_nis_ortu", Context.MODE_PRIVATE);
    ...
    public String sendGetRequestOldPass() {
        ...
        try {
            URL url = new URL("https://eduscotest.educationscoring.com/Ortu/showpass_ortu.php?nis=" + nis + "&password=" + oldpass);
    ...
    public String sendGetRequestNewPass() {
        StringBuilder sb = new StringBuilder();
        try {
            URL url = new URL("https://eduscotest.educationscoring.com/Ortu/changepass_ortu.php?nis=" + nis +
        ...
        try {
            ...
            for (int i = 0; i < result.length(); i++) {
                ...
                if (getpassold.isEmpty()) {
                    ...
                    // Perintah berjalan ketika password baru benar
