...
public class CariNISOrtuActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public void onBackPressed() {
        Intent i = new Intent(CariNISOrtuActivity.this, LoginOrtuActivity.class);
        startActivity(i);
        finish();
    }
    ...
    private void showSiswa() {
        ...
        ListAdapter adapter = new SimpleAdapter(
                CariNISOrtuActivity.this, list, R.layout.list_cari,
                new String[]{"NIS", "Nama"},
