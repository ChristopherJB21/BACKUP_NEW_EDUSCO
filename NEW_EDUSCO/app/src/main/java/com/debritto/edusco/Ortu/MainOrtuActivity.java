...
import com.debritto.edusco.Ortu.Fragment.ProfileOrtuFragment;
...
public class MainOrtuActivity extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.menu_profile:
                ...
                fragment = new ProfileOrtuFragment();
                break;
        }
